...
class ProfilePolicy
{
    ...
    {
       return $user->id == $profile->user_id; //The currently logged in user, matches the profile id - ie they 'own' that profile. As above, determine if a user can update a profile.
    }
